			...
			<div class="row">
				<div class="col-xl-6 col-sm-12">
					<div class="card">
						...
						<div class="card-body">
							<div class="row">
								<?= form_open('/editibt/'.$voucher_data['voucher_id']) ?>									
									...
									<div class="col-xl-12 col-sm-12 mb-3">
										...
										<input type="text" class="form-control" name="bank_name" value="<?= $voucher_data['bank_name'] ?>">
									...
									<div class="col-xl-12 col-sm-12 mb-3">
										...
										<input type="text" class="form-control" name="account_number" data-mask="0000000000" data-reverse="true" value="<?= $voucher_data['account_number'] ?>">
