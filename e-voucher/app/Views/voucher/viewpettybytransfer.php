				...
				<div class="col-12">
					<div class="card">
						...
						<div class="card-body">
							<div class="row">
								...
								<div class="col-md-6 text-center my-5">
									...
									<div class="text-muted"><i data-feather="phone"></i> <?= $company_data['company_phone'] ?><?php if($company_data['company_mobile'] != ''): ?>, <?= $company_data['company_mobile'] ?><?php endif ?></div>
								</div>
							</div>
							<div class="row my-4">
								...
								<table class="table table-bordered">
									<tbody>
										...
										<tr>
											<?php if($voucher_data['outlet_id'] == '1'): ?>
												...
												<td><strong>Bank Name: </strong> <br>
													<?= $voucher_data['bank_name'] ?>
												</td>
											<?php else: ?>
												<td colspan="2"><strong>Bank Name: </strong> <br>
													<?= $voucher_data['bank_name'] ?>
												</td>
											<?php endif ?>
										</tr>
										<tr>
											...
											<td colspan="2"><strong>Account Number: </strong> <br>
												<?= $voucher_data['account_number'] ?>
											</td>
										</tr>
										<tr>
						...
						<div class="text-center">
						    <a href="<?= base_url() ?>/print_ibt/<?= $voucher_data['voucher_id'] ?>" class="btn btn-primary">Print Voucher</a>
						</div>
					</div>
				</div>
			</div>
