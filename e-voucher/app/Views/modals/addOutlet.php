<div class="modal fade" id="addOutlet" tabindex="-1" role="dialog" aria-hidden="true">
			...
			<div class="modal-body m-3">
				<div class="col-12 col-lg-12">
					<div class="form-floating mb-3">
						<input type="text" class="form-control" id="floatingInput1" name="outlet_name" value="<?= set_value('outlet_name') ?>">
